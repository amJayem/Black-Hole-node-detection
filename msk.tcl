# AODV with Blackhole node - 20 nodes
...
#Open new files according to endpoints
    set udpf [open blackholeudpf.tr w]
    
#Define a finish procedure
proc finish {} {
    global ns tracefile namfile udp0 udp1 udp2 udp3
    $ns flush-trace
    close $tracefile
    close $namfile

#Execute Xgraph files
    exec xgraph blackholeudpf.tr -geometry 800x400 &
...
#Define AWK file
    ...
    exec awk -f calculate.awk blackhole.tr &
    exit 0
}    
